    ...
    <div class="container bg-light p-5" style="border-radius: 20px;">
        <div class="row my-5">
            <div class="col-md-6 d-flex align-items-center">
                <div>
                    <h2>Selamat Datang di Rumah Gurit <br><b>Rogojampi</b></h2>
                    <p class="text-secondary">Tempat Berkumpulnya para pemain ML, <br>Daftarkan Sekarang! Diri anda sebagai member Arit </p>
